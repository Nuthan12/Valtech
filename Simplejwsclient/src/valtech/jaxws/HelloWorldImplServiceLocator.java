...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements valtech.jaxws.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:8080/valtechjaxws/services/HelloWorldImplPort";
    ...
    public valtech.jaxws.HelloWorld getHelloWorldImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public valtech.jaxws.HelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            valtech.jaxws.HelloWorldImplServiceSoapBindingStub _stub = new valtech.jaxws.HelloWorldImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (valtech.jaxws.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                valtech.jaxws.HelloWorldImplServiceSoapBindingStub _stub = new valtech.jaxws.HelloWorldImplServiceSoapBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jaxws.valtech/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jaxws.valtech/", "HelloWorldImplPort"));
        }
